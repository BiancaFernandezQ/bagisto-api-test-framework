...
from src.assertions.response_assertions import assert_valid_schema, assert_response_contiene_data_y_meta, assert_response_contiene_data, assert_content_type_es_json, assert_response_contiene_campo
...
def test_crear_grupo_con_ambos_campos_validos_return_200(get_token, group_teardown):
    ...
    response = GroupService.create_group(get_token, grupo)
...
def test_crear_grupo_con_code_duplicado_no_unico_return_400(get_token, group_teardown):
    ...
    primer_grupo = GroupService.create_group(get_token, grupo_original)
    ...
    segundo_grupo = GroupService.create_group(get_token, grupo_duplicado)
